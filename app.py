...
if page == "Log Catch":
    ...
    if submitted_log:
        ...
        st.session_state.catch_log.append(catch_entry)
    ...
    if len(st.session_state.catch_log) == 0:
        ...
        if not delete_options_df.empty:
            ...
            if st.button("Delete Selected Catch", key="delete_selected_catch_btn"):
                ...
                del st.session_state.catch_log[original_index]
...
# -------------------------------------------------
st.markdown("---")
st.caption("Prototype app using live weather + NOAA tide data with an XGBoost fishing success model.")
